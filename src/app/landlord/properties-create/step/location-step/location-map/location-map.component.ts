...
export class LocationMapComponent {
  ...
  constructor() {
    ...
    this.overrideDefaultLeafletIconLocation()
  }

  overrideDefaultLeafletIconLocation() {
    //To resolve this bug that seems to from leaflet, added the images to this folder src/assets/leaflet from the leaflet module then Override default icon options
    delete (L.Icon.Default.prototype as any)._getIconUrl;

    L.Icon.Default.mergeOptions({
      iconRetinaUrl: 'assets/leaflet/marker-icon-2x.png', // path to retina icon
      iconUrl: 'assets/leaflet/marker-icon.png', // path to regular icon
      shadowUrl: 'assets/leaflet/marker-shadow.png' // path to shadow icon
    });
  }
